...
ext_modules = [
    ...
    include_dirs=list(map(lambda x:os.path.abspath(x),['Familia/include','third_party/include', '/usr/include'])),
...
#         c_opts['unix'] += ['-flat_namespace',"-lstdc++",'-mmacosx-version-min=10.7']
